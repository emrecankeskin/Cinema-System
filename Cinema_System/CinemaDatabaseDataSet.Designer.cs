...
namespace Cinema_System {
    ...
    public partial class CinemaDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class tblUserDataTable : global::System.Data.TypedTableBase<tblUserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tblUserRow AddtblUserRow(string name, string surname, string password, string username) {
            ...
            public string username {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("\'tblUser\' tablosundaki \'username\' sütunun değeri DBNull.", e);
                    }
                }
                set {
...
namespace Cinema_System.CinemaDatabaseDataSetTableAdapters {
    ...
    public partial class tblUserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tblUser] WHERE (([user_id] = @Original_user_id) AND ([name] = @Original_name) AND ([surname] = @Original_surname) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tblUser] ([name], [surname], [password], [username]) VALUES (@" +
                "name, @surname, @password, @username);\r\nSELECT user_id, name, surname, password," +
                " username FROM tblUser WHERE (user_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tblUser] SET [name] = @name, [surname] = @surname, [password] = @password, [username] = @username WHERE (([user_id] = @Original_user_id) AND ([name] = @Original_name) AND ([surname] = @Original_surname) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)));
SELECT user_id, name, surname, password, username FROM tblUser WHERE (user_id = @user_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Cinema_System.Properties.Settings.Default.CinemaDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT user_id, name, surname, password, username FROM dbo.tblUser";
        ...
        public virtual int Fill(CinemaDatabaseDataSet.tblUserDataTable dataTable) {
        ...
        public virtual CinemaDatabaseDataSet.tblUserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CinemaDatabaseDataSet.tblUserDataTable dataTable = new CinemaDatabaseDataSet.tblUserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CinemaDatabaseDataSet.tblUserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_user_id, string Original_name, string Original_surname, string Original_password, string Original_username) {
        ...
        public virtual int Insert(string name, string surname, string password, string username) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string surname, string password, string username, int Original_user_id, string Original_name, string Original_surname, string Original_password, string Original_username, int user_id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string surname, string password, string username, int Original_user_id, string Original_name, string Original_surname, string Original_password, string Original_username) {
            return this.Update(name, surname, password, username, Original_user_id, Original_name, Original_surname, Original_password, Original_username, Original_user_id);
        }
    }
        ...
        public virtual int UpdateAll(CinemaDatabaseDataSet dataSet) {
            ...
            try {
                ...
                if ((this._tblUserTableAdapter != null)) {
                    ...
                    this._tblUserTableAdapter.Connection = ((global::Microsoft.Data.SqlClient.SqlConnection)(workConnection));
                    this._tblUserTableAdapter.Transaction = ((global::Microsoft.Data.SqlClient.SqlTransaction)(workTransaction));
                ...
                if ((this._tblUserTableAdapter != null)) {
                    this._tblUserTableAdapter.Connection = ((global::Microsoft.Data.SqlClient.SqlConnection)(revertConnections[this._tblUserTableAdapter]));
